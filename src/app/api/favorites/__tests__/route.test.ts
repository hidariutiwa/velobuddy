...
import { createFavorite, getFavoritesByUserId, upsertPlace } from "@/lib/db/place";
...
const mockGetFavoritesByUserId = getFavoritesByUserId as jest.MockedFunction<typeof getFavoritesByUserId>;
const mockUpsertPlace = upsertPlace as jest.MockedFunction<typeof upsertPlace>;
const mockCreateFavorite = createFavorite as jest.MockedFunction<typeof createFavorite>;
